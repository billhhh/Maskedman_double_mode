...
**
** Created: Sat Oct 11 11:00:42 2014
...
static const char qt_meta_stringdata_PlayThread[] = {
    ...
    "sendMmrInfo(int)\0playEnd()\0threadEnd()\0"
};
...
void PlayThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->sendMmrInfo((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->playEnd(); break;
        case 5: _t->threadEnd(); break;
        default: ;
        }
    }
}
...
// SIGNAL 3
void PlayThread::sendMmrInfo(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
